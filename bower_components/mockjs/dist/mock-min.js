	...
	*/
            ...
            if (void 0 != t.rule.min)
              for (
                ...
                (r = e[u]),
                  ...
                  (l[a] = Handler.gen(t.template[r], r, {
                    path: t.context.path,
                    templatePath: t.context.templatePath,
                    currentContext: l,
                    templateCurrentContext: t.template,
                    root: t.context.root || l,
                    templateRoot: t.context.templateRoot || t.template,
                  })),
                  t.context.path.pop(),
                  t.context.templatePath.pop();
        ...
        Handler.extend({
          ...
          getValueByKeyPath: function(t, e) {
            ...
            '/' === t.charAt(0)
              ...
              (t = r[r.length - 1]);
            for (
              var o = e.context.root, u = e.context.templateRoot, l = 1;
              l < a.length - 1;
              l++
            )
              (o = o[a[l]]), (u = u[a[l]]);
      ...
      t.exports = {
        parse: function(t) {
          ...
          var e = (t || '').match(r.RE_KEY),
            ...
            l = n ? (n[2] ? a.integer(o, u) : parseInt(n[1], 10)) : void 0,
            i = e && e[4] && e[4].match(r.RE_RANGE),
            s = i && parseInt(i[1], 10),
            c = i && parseInt(i[2], 10),
            h = i ? (!i[2] && parseInt(i[1], 10)) || a.integer(s, c) : void 0,
            p = {
              parameters: e,
              range: n,
              min: o,
      ...
      t.exports = {
        ...
        hsl2rgb: function(t) {
          var e,
            ...
            l = t[1] / 100,
            i = t[2] / 100;
          if (0 === l) return (o = 255 * i), [o, o, o];
          (n = 0.5 > i ? i * (1 + l) : i + l - i * l),
            (e = 2 * i - n),
            (a = [0, 0, 0]);
          for (var s = 0; 3 > s; s++)
            (r = u + (1 / 3) * -(s - 1)),
    ...
    function(t, e) {
      t.exports = {
        ...
        pick: function(t, e, n) {
          switch (((t = t || []), arguments.length)) {
            case 1:
              return t[this.natural(0, t.length - 1)];
            case 2:
              n = e;
            case 3:
              return this.shuffle(t, e, n);
          }
        },
        shuffle: function(t, e, n) {
          t = t || [];
          for (
            var r = t.slice(0), a = [], o = 0, u = r.length, l = 0;
            u > l;
            l++
          )
        ...
        order: function n(t) {
          ...
          var e = n.options,
            r = e.context.templatePath.join('.'),
            a = (n.cache[r] = n.cache[r] || { index: 0, array: t });
    ...
    function(t, e) {
      ...
      var v = (function() {
          ...
          function v(t) {
            ...
            function k() {
              var t, e, n, r, a;
              if (((t = Zn), (e = E()), null === e && (e = Rt), null !== e))
                if (
                  ((n = Zn),
                  ar++,
                  (r = M()),
                  ar--,
                  null === r ? (n = Rt) : ((Zn = n), (n = kt)),
                  null !== n)
                ) {
                  for (r = [], a = _(), null === a && (a = R()); null !== a; )
                    r.push(a), (a = _()), null === a && (a = R());
                  null !== r
                    ? ((a = A()),
                      null === a && (a = Rt),
                      null !== a
          ...
          'invert-charset': function(t, e, n) {
            for (var r, a = h, u = 0; u < t.body.length; u++)
              switch (((r = t.body[u]), r.type)) {
                ...
                case 'range':
                  for (
                    var l = this.gen(r.start, e, n).charCodeAt(),
                      i = this.gen(r.end, e, n).charCodeAt(),
                      s = l;
                    i >= s;
                    s++
                  )
    ...
    function(t, e, n) {
      function r(t, e, n) {
        ...
        switch (
          ((l.path = n.slice(0)),
          l.path.push(void 0 === e ? 'ROOT' : l.name),
          l.type)
        ) {
          case 'array':
            (l.items = []),
              o.each(t, function(t, e) {
                l.items.push(r(t, e, l.path));
              });
            break;
          case 'object':
            (l.properties = []),
              o.each(t, function(t, e) {
                l.properties.push(r(t, e, l.path));
              });
        }
        return l;
      }
    ...
    function(t, e, n) {
      function r(t, e) {
        for (var n = o(t), r = u.diff(n, e), a = 0; a < r.length; a++);
        return r;
      }
      var a = n(3),
        o = n(23),
        u = {
          ...
          name: function(t, e, n, r) {
            var a = r.length;
            return (
              l.equal('name', t.path, n + '', t.name + '', r),
              r.length !== a ? !1 : !0
            );
          },
          type: function(t, e, n, r) {
            var o = r.length;
            return (
              l.equal('type', t.path, a.type(e), t.type, r),
              r.length !== o ? !1 : !0
            );
          },
          value: function(t, e, n, r) {
            ...
            if ('object' !== i && 'array' !== i) {
              if (!t.rule.parameters)
                return void l.equal('value', t.path, e, t.template, r);
              switch (i) {
                case 'number':
                  var s = (e + '').split('.');
                  (s[0] = +s[0]),
                    void 0 !== u.min &&
                      void 0 !== u.max &&
                      (l.greaterThanOrEqualTo('value', t.path, s[0], u.min, r),
                      l.lessThanOrEqualTo('value', t.path, s[0], u.max, r)),
                    void 0 !== u.min &&
                      void 0 === u.max &&
                ...
                case 'string':
                  ...
                  (c = c ? c.length : c),
                    void 0 !== u.min &&
                      void 0 !== u.max &&
                      (l.greaterThanOrEqualTo('value', t.path, c, u.min, r),
                      l.lessThanOrEqualTo('value', t.path, c, u.max, r)),
                    void 0 !== u.min &&
                      void 0 === u.max &&
                      l.equal('value', t.path, c, u.min, r);
              }
              return r.length !== o ? !1 : !0;
            }
          },
        ...
        l = {
          message: function(t) {
            return (
              ...
              .replace(
                '{path}',
                (a.isArray(t.path) && t.path.join('.')) || t.path,
              )
    ...
    function(t, e, n) {
      ...
      function u(t, e) {
        return l.isFunction(t.template)
          ? t.template(e)
      ...
      (r._settings = { timeout: '10-100' }),
        (r.setup = function(t) {
          return l.extend(r._settings, t), r._settings;
        }),
        l.extend(r, s),
        l.extend(r.prototype, s),
        (r.prototype.mock = !0),
        (r.prototype.match = !1),
        l.extend(r.prototype, {
          open: function(t, e, n, u, i) {
            function s(t) {
            ...
            if (!f) {
              var d = a();
              this.custom.xhr = d;
              for (var m = 0; m < c.length; m++) d.addEventListener(c[m], s);
              return void (u ? d.open(t, e, n, u, i) : d.open(t, e, n));
            }
            (this.match = !0),
